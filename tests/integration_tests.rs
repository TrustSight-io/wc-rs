...
fn test_lines_only_flag() {
    ...
    let our_lines: usize = our_output.split_whitespace().next().unwrap().parse().unwrap();
    let sys_lines: usize = sys_output.split_whitespace().next().unwrap().parse().unwrap();
...
fn test_words_only_flag() {
    ...
    let our_words: usize = our_output.split_whitespace().next().unwrap().parse().unwrap();
    let sys_words: usize = sys_output.split_whitespace().next().unwrap().parse().unwrap();
...
fn test_chars_only_flag() {
    ...
    let our_chars: usize = our_output.split_whitespace().next().unwrap().parse().unwrap();
    let sys_chars: usize = sys_output.split_whitespace().next().unwrap().parse().unwrap();
...
fn test_multiple_files() {
    let files = ["tests/data/small.txt", "tests/data/trivial.txt", "tests/data/empty.txt"];
...
fn test_stdin_processing() {
    ...
    our_child.stdin.as_mut().unwrap().write_all(test_input.as_bytes()).unwrap();
    ...
    sys_child.stdin.as_mut().unwrap().write_all(test_input.as_bytes()).unwrap();
...
fn test_performance_large_file() {
    ...
    println!("Speedup: {:.2}x", sys_time.as_secs_f64() / our_time.as_secs_f64());
